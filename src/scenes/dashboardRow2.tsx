...
import {
  useGetKpisQuery,
  useGetProductsQuery,
} from "@/core/services/kpis.service";
...
export const DashboardRow2 = () => {
  ...
  const pieColors = [palette.primary[800], palette.secondary[300]];
  ...
  return (
    <>
      <DashboardBoxComponent gridArea="d">
        <Header
          icon=""
      ...
      <DashboardBoxComponent gridArea="e">
        <Header
          icon=""
      ...
      <DashboardBoxComponent gridArea="f">
        <Header
          icon=""
